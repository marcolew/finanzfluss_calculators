...
export function Lohnsteuer2019(params = {}) {
  /* Input variables */
 ...
 */
Object.defineProperty(Lohnsteuer2019, 'TAB1', {
  value: [
 ...
 */
Object.defineProperty(Lohnsteuer2019, 'TAB2', {
  value: [
 ...
 */
Object.defineProperty(Lohnsteuer2019, 'TAB3', {
  value: [
    BigDecimal.valueOf(0),
    BigDecimal.valueOf(900),
 ...
 */
Object.defineProperty(Lohnsteuer2019, 'TAB4', {
  value: [
    BigDecimal.valueOf(0.0),
    BigDecimal.valueOf(0.4),
    BigDecimal.valueOf(0.384),
 ...
 */
Object.defineProperty(Lohnsteuer2019, 'TAB5', {
  value: [
    BigDecimal.valueOf(0),
...
Object.defineProperty(Lohnsteuer2019, 'ZAHL1000', {
  value: new BigDecimal(1000),
})
Object.defineProperty(Lohnsteuer2019, 'ZAHL10000', {
...
Lohnsteuer2019.prototype.MRE4JL = function () {
  if (this.LZZ == 1) {
    ...
    if (this.LZZ == 2) {
      this.ZRE4J = this.RE4.multiply(Lohnsteuer2019.ZAHL12).divide(
        Lohnsteuer2019.ZAHL100,
        2,
        BigDecimal.ROUND_DOWN,
      )
      this.ZVBEZJ = this.VBEZ.multiply(Lohnsteuer2019.ZAHL12).divide(
        Lohnsteuer2019.ZAHL100,
        2,
        BigDecimal.ROUND_DOWN,
      )
      this.JLFREIB = this.LZZFREIB.multiply(Lohnsteuer2019.ZAHL12).divide(
        Lohnsteuer2019.ZAHL100,
        2,
        BigDecimal.ROUND_DOWN,
      )
      this.JLHINZU = this.LZZHINZU.multiply(Lohnsteuer2019.ZAHL12).divide(
        Lohnsteuer2019.ZAHL100,
        2,
        BigDecimal.ROUND_DOWN,
      )
      ...
      if (this.LZZ == 3) {
        this.ZRE4J = this.RE4.multiply(Lohnsteuer2019.ZAHL360).divide(
          Lohnsteuer2019.ZAHL700,
          2,
          BigDecimal.ROUND_DOWN,
        )
        this.ZVBEZJ = this.VBEZ.multiply(Lohnsteuer2019.ZAHL360).divide(
          Lohnsteuer2019.ZAHL700,
          2,
          BigDecimal.ROUND_DOWN,
        )
        this.JLFREIB = this.LZZFREIB.multiply(Lohnsteuer2019.ZAHL360).divide(
          Lohnsteuer2019.ZAHL700,
          2,
          BigDecimal.ROUND_DOWN,
        )
        this.JLHINZU = this.LZZHINZU.multiply(Lohnsteuer2019.ZAHL360).divide(
          Lohnsteuer2019.ZAHL700,
          2,
          BigDecimal.ROUND_DOWN,
        )
...
Lohnsteuer2019.prototype.MRE4 = function () {
  if (this.ZVBEZJ.compareTo(BigDecimal.ZERO()) == 0) {
    ...
    if (this.LZZ == 1) {
      ...
      this.VBEZB = this.VBEZM.multiply(Lohnsteuer2019.ZAHL12)
        .add(this.VBEZS)
        .setScale(2, BigDecimal.ROUND_DOWN)
      this.HFVB = Lohnsteuer2019.TAB2[this.J]
      this.FVBZ = Lohnsteuer2019.TAB3[this.J]
    }
    this.FVB = this.VBEZB.multiply(Lohnsteuer2019.TAB1[this.J])
      .divide(Lohnsteuer2019.ZAHL100)
    ...
    this.FVBSO = this.FVB.add(
      this.VBEZBSO.multiply(Lohnsteuer2019.TAB1[this.J]).divide(
        Lohnsteuer2019.ZAHL100,
      ),
    ).setScale(2, BigDecimal.ROUND_UP)
    if (this.FVBSO.compareTo(Lohnsteuer2019.TAB2[this.J]) == 1) {
      this.FVBSO = Lohnsteuer2019.TAB2[this.J]
    }
    ...
    this.FVBZSO = this.FVBZ.add(
      this.VBEZBSO.divide(Lohnsteuer2019.ZAHL100),
    ).setScale(0, BigDecimal.ROUND_UP)
    if (this.FVBZSO.compareTo(this.HFVBZSO) == 1) {
      this.FVBZSO = this.HFVBZSO.setScale(0, BigDecimal.ROUND_UP)
    }
    if (this.FVBZSO.compareTo(Lohnsteuer2019.TAB3[this.J]) == 1) {
      this.FVBZSO = Lohnsteuer2019.TAB3[this.J]
    }
    this.HFVBZ = this.VBEZB.divide(Lohnsteuer2019.ZAHL100)
      .subtract(this.FVB)
      .setScale(2, BigDecimal.ROUND_DOWN)
...
Lohnsteuer2019.prototype.MRE4ALTE = function () {
  if (this.ALTER1 == 0) {
    ...
    this.ALTE = this.BMG.multiply(Lohnsteuer2019.TAB4[this.K]).setScale(
      0,
      BigDecimal.ROUND_UP,
    )
...
Lohnsteuer2019.prototype.MRE4ABZ = function () {
  ...
  if (this.KENNVMT == 2) {
    this.ZRE4VP = this.ZRE4VP.subtract(
      this.ENTSCH.divide(Lohnsteuer2019.ZAHL100),
    ).setScale(2, BigDecimal.ROUND_DOWN)
  }
...
Lohnsteuer2019.prototype.MBERECH = function () {
  ...
  this.VFRB = this.ANP.add(this.FVB.add(this.FVBZ))
    .multiply(Lohnsteuer2019.ZAHL100)
...
Lohnsteuer2019.prototype.MZTABFB = function () {
  ...
  if (this.STKL < 6) {
    if (this.ZRE4.compareTo(this.ZVBEZ) == 1) {
      if (
        this.ZRE4.subtract(this.ZVBEZ).compareTo(Lohnsteuer2019.ZAHL1000) == -1
      ) {
        this.ANP = this.ANP.add(this.ZRE4)
          .subtract(this.ZVBEZ)
          .setScale(0, BigDecimal.ROUND_UP)
      } else {
        this.ANP = this.ANP.add(Lohnsteuer2019.ZAHL1000)
      }
    }
  }
  this.KZTAB = 1
  if (this.STKL == 1) {
    ...
    this.KFB = this.ZKF.multiply(BigDecimal.valueOf(7620)).setScale(
      0,
      BigDecimal.ROUND_DOWN,
    )
  } else {
    if (this.STKL == 2) {
      ...
      if (this.STKL == 3) {
        ...
        if (this.STKL == 4) {
          this.SAP = BigDecimal.valueOf(36)
          this.KFB = this.ZKF.multiply(BigDecimal.valueOf(3810)).setScale(
            0,
            BigDecimal.ROUND_DOWN,
          )
        } else {
...
Lohnsteuer2019.prototype.MLSTJAHR = function () {
  ...
  if (this.KENNVMT != 1) {
    ...
    this.ZVE = this.ZRE4.subtract(this.ZTABFB)
      .subtract(this.VSP)
      .subtract(this.VMT.divide(Lohnsteuer2019.ZAHL100))
      .subtract(this.VKAPA.divide(Lohnsteuer2019.ZAHL100))
      .setScale(2, BigDecimal.ROUND_DOWN)
    if (this.ZVE.compareTo(BigDecimal.ZERO()) == -1) {
      this.ZVE = this.ZVE.add(this.VMT.divide(Lohnsteuer2019.ZAHL100))
        .add(this.VKAPA.divide(Lohnsteuer2019.ZAHL100))
        .divide(Lohnsteuer2019.ZAHL5)
        .setScale(2, BigDecimal.ROUND_DOWN)
      this.UPMLST()
      this.ST = this.ST.multiply(Lohnsteuer2019.ZAHL5).setScale(
        0,
        BigDecimal.ROUND_DOWN,
      )
    } else {
      ...
      this.ZVE = this.ZVE.add(
        this.VMT.add(this.VKAPA).divide(Lohnsteuer2019.ZAHL500),
      ).setScale(2, BigDecimal.ROUND_DOWN)
      this.UPMLST()
      this.ST = this.ST.subtract(this.STOVMT)
        .multiply(Lohnsteuer2019.ZAHL5)
        .add(this.STOVMT)
        .setScale(0, BigDecimal.ROUND_DOWN)
    }
  }
...
Lohnsteuer2019.prototype.UPVKV = function () {
  if (this.PKV > 0) {
    if (this.VSP2.compareTo(this.VSP3) == 1) {
      this.VKV = this.VSP2.multiply(Lohnsteuer2019.ZAHL100)
    } else {
      this.VKV = this.VSP3.multiply(Lohnsteuer2019.ZAHL100)
    }
  } else {
...
Lohnsteuer2019.prototype.MVSP = function () {
  ...
  if (this.PKV > 0) {
    if (this.STKL == 6) {
      ...
      this.VSP3 = this.PKPV.multiply(Lohnsteuer2019.ZAHL12).divide(
        Lohnsteuer2019.ZAHL100,
      )
      if (this.PKV == 2) {
...
Lohnsteuer2019.prototype.MSOLZ = function () {
  ...
  if (this.JBMG.compareTo(this.SOLZFREI) == 1) {
    ...
    this.JW = this.SOLZJ.multiply(Lohnsteuer2019.ZAHL100).setScale(
      0,
      BigDecimal.ROUND_DOWN,
    )
    this.UPANTEIL()
  ...
  if (this.LZZ == 1) {
    ...
    if (this.LZZ == 2) {
      this.ANTEIL1 = this.JW.divide(
        Lohnsteuer2019.ZAHL12,
        0,
        BigDecimal.ROUND_DOWN,
      )
    } else {
      if (this.LZZ == 3) {
        this.ANTEIL1 = this.JW.multiply(Lohnsteuer2019.ZAHL7).divide(
          Lohnsteuer2019.ZAHL360,
          0,
          BigDecimal.ROUND_DOWN,
        )
      } else {
...
Lohnsteuer2019.prototype.MSONST = function () {
  ...
  if (this.SONSTB.compareTo(BigDecimal.ZERO()) == 0) {
    ...
    this.STS = this.LSTSO.subtract(this.LSTOSO)
      ...
      .divide(Lohnsteuer2019.ZAHL100, 0, BigDecimal.ROUND_DOWN)
      .multiply(Lohnsteuer2019.ZAHL100)
...
Lohnsteuer2019.prototype.MVMT = function () {
  ...
  if (this.VMT.add(this.VKAPA).compareTo(BigDecimal.ZERO()) == 1) {
    ...
    this.MRE4ABZ()
    this.ZRE4VP = this.ZRE4VP.subtract(
      this.JRE4ENT.divide(Lohnsteuer2019.ZAHL100),
    ).subtract(this.SONSTENT.divide(Lohnsteuer2019.ZAHL100))
    this.KENNVMT = 1
    this.MLSTJAHR()
...
Lohnsteuer2019.prototype.MOSONST = function () {
  this.ZRE4J = this.JRE4.divide(Lohnsteuer2019.ZAHL100).setScale(
    2,
    BigDecimal.ROUND_DOWN,
  )
  this.ZVBEZJ = this.JVBEZ.divide(Lohnsteuer2019.ZAHL100).setScale(
    2,
    BigDecimal.ROUND_DOWN,
  )
...
Lohnsteuer2019.prototype.UPTAB19 = function () {
  if (this.X.compareTo(this.GFB.add(Lohnsteuer2019.ZAHL1)) == -1) {
    this.ST = BigDecimal.ZERO()
  } else {
    if (this.X.compareTo(BigDecimal.valueOf(14255)) == -1) {
      this.Y = this.X.subtract(this.GFB).divide(
        Lohnsteuer2019.ZAHL10000,
        6,
        BigDecimal.ROUND_DOWN,
      )
      ...
      if (this.X.compareTo(BigDecimal.valueOf(55961)) == -1) {
        this.Y = this.X.subtract(BigDecimal.valueOf(14254)).divide(
          Lohnsteuer2019.ZAHL10000,
          6,
          BigDecimal.ROUND_DOWN,
        )
        ...
        this.ST = this.RW.add(BigDecimal.valueOf(965.58)).setScale(
          0,
          BigDecimal.ROUND_DOWN,
        )
      } else {
        if (this.X.compareTo(BigDecimal.valueOf(265327)) == -1) {
          this.ST = this.X.multiply(BigDecimal.valueOf(0.42))
            .subtract(BigDecimal.valueOf(8780.9))
            .setScale(0, BigDecimal.ROUND_DOWN)
        } else {
          this.ST = this.X.multiply(BigDecimal.valueOf(0.45))
            .subtract(BigDecimal.valueOf(16740.68))
            .setScale(0, BigDecimal.ROUND_DOWN)
        }
      }
    }
