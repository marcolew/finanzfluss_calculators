...
export function Lohnsteuer2020(params = {}) {
  /* Input variables */
 ...
 */
Object.defineProperty(Lohnsteuer2020, 'TAB1', {
  value: [
 ...
 */
Object.defineProperty(Lohnsteuer2020, 'TAB2', {
  value: [
 ...
 */
Object.defineProperty(Lohnsteuer2020, 'TAB3', {
  value: [
    BigDecimal.valueOf(0),
    BigDecimal.valueOf(900),
 ...
 */
Object.defineProperty(Lohnsteuer2020, 'TAB4', {
  value: [
    BigDecimal.valueOf(0.0),
    BigDecimal.valueOf(0.4),
    BigDecimal.valueOf(0.384),
 ...
 */
Object.defineProperty(Lohnsteuer2020, 'TAB5', {
  value: [
    BigDecimal.valueOf(0),
...
Object.defineProperty(Lohnsteuer2020, 'ZAHL1000', {
  value: new BigDecimal(1000),
})
Object.defineProperty(Lohnsteuer2020, 'ZAHL10000', {
...
Lohnsteuer2020.prototype.MPARA = function () {
  if (this.KRV < 2) {
    if (this.KRV == 0) {
      this.BBGRV = new BigDecimal(82800)
    } else {
      this.BBGRV = new BigDecimal(77400)
    }
    this.RVSATZAN = BigDecimal.valueOf(0.093)
    this.TBSVORV = BigDecimal.valueOf(0.8)
  }
  this.BBGKVPV = new BigDecimal(56250)
  this.bd = new BigDecimal(2)
  this.KVSATZAN = this.KVZ.divide(this.bd)
    .divide(Lohnsteuer2020.ZAHL100)
    .add(BigDecimal.valueOf(0.07))
  this.KVSATZAG = BigDecimal.valueOf(0.0055 + 0.07)
  if (this.PVS == 1) {
...
Lohnsteuer2020.prototype.MRE4JL = function () {
  if (this.LZZ == 1) {
    ...
    if (this.LZZ == 2) {
      this.ZRE4J = this.RE4.multiply(Lohnsteuer2020.ZAHL12).divide(
        Lohnsteuer2020.ZAHL100,
        2,
        BigDecimal.ROUND_DOWN,
      )
      this.ZVBEZJ = this.VBEZ.multiply(Lohnsteuer2020.ZAHL12).divide(
        Lohnsteuer2020.ZAHL100,
        2,
        BigDecimal.ROUND_DOWN,
      )
      this.JLFREIB = this.LZZFREIB.multiply(Lohnsteuer2020.ZAHL12).divide(
        Lohnsteuer2020.ZAHL100,
        2,
        BigDecimal.ROUND_DOWN,
      )
      this.JLHINZU = this.LZZHINZU.multiply(Lohnsteuer2020.ZAHL12).divide(
        Lohnsteuer2020.ZAHL100,
        2,
        BigDecimal.ROUND_DOWN,
      )
      ...
      if (this.LZZ == 3) {
        this.ZRE4J = this.RE4.multiply(Lohnsteuer2020.ZAHL360).divide(
          Lohnsteuer2020.ZAHL700,
          2,
          BigDecimal.ROUND_DOWN,
        )
        this.ZVBEZJ = this.VBEZ.multiply(Lohnsteuer2020.ZAHL360).divide(
          Lohnsteuer2020.ZAHL700,
          2,
          BigDecimal.ROUND_DOWN,
        )
        this.JLFREIB = this.LZZFREIB.multiply(Lohnsteuer2020.ZAHL360).divide(
          Lohnsteuer2020.ZAHL700,
          2,
          BigDecimal.ROUND_DOWN,
        )
        this.JLHINZU = this.LZZHINZU.multiply(Lohnsteuer2020.ZAHL360).divide(
          Lohnsteuer2020.ZAHL700,
          2,
          BigDecimal.ROUND_DOWN,
        )
...
Lohnsteuer2020.prototype.MRE4 = function () {
  if (this.ZVBEZJ.compareTo(BigDecimal.ZERO()) == 0) {
    ...
    if (this.LZZ == 1) {
      ...
      this.VBEZB = this.VBEZM.multiply(Lohnsteuer2020.ZAHL12)
        .add(this.VBEZS)
        .setScale(2, BigDecimal.ROUND_DOWN)
      this.HFVB = Lohnsteuer2020.TAB2[this.J]
      this.FVBZ = Lohnsteuer2020.TAB3[this.J]
    }
    this.FVB = this.VBEZB.multiply(Lohnsteuer2020.TAB1[this.J])
      .divide(Lohnsteuer2020.ZAHL100)
    ...
    this.FVBSO = this.FVB.add(
      this.VBEZBSO.multiply(Lohnsteuer2020.TAB1[this.J]).divide(
        Lohnsteuer2020.ZAHL100,
      ),
    ).setScale(2, BigDecimal.ROUND_UP)
    if (this.FVBSO.compareTo(Lohnsteuer2020.TAB2[this.J]) == 1) {
      this.FVBSO = Lohnsteuer2020.TAB2[this.J]
    }
    ...
    this.FVBZSO = this.FVBZ.add(
      this.VBEZBSO.divide(Lohnsteuer2020.ZAHL100),
    ).setScale(0, BigDecimal.ROUND_UP)
    if (this.FVBZSO.compareTo(this.HFVBZSO) == 1) {
      this.FVBZSO = this.HFVBZSO.setScale(0, BigDecimal.ROUND_UP)
    }
    if (this.FVBZSO.compareTo(Lohnsteuer2020.TAB3[this.J]) == 1) {
      this.FVBZSO = Lohnsteuer2020.TAB3[this.J]
    }
    this.HFVBZ = this.VBEZB.divide(Lohnsteuer2020.ZAHL100)
      .subtract(this.FVB)
      .setScale(2, BigDecimal.ROUND_DOWN)
...
Lohnsteuer2020.prototype.MRE4ALTE = function () {
  if (this.ALTER1 == 0) {
    ...
    this.ALTE = this.BMG.multiply(Lohnsteuer2020.TAB4[this.K]).setScale(
      0,
      BigDecimal.ROUND_UP,
    )
...
Lohnsteuer2020.prototype.MRE4ABZ = function () {
  ...
  if (this.KENNVMT == 2) {
    this.ZRE4VP = this.ZRE4VP.subtract(
      this.ENTSCH.divide(Lohnsteuer2020.ZAHL100),
    ).setScale(2, BigDecimal.ROUND_DOWN)
  }
...
Lohnsteuer2020.prototype.MBERECH = function () {
  ...
  this.VFRB = this.ANP.add(this.FVB.add(this.FVBZ))
    .multiply(Lohnsteuer2020.ZAHL100)
...
Lohnsteuer2020.prototype.MZTABFB = function () {
  ...
  if (this.STKL < 6) {
    if (this.ZRE4.compareTo(this.ZVBEZ) == 1) {
      if (
        this.ZRE4.subtract(this.ZVBEZ).compareTo(Lohnsteuer2020.ZAHL1000) == -1
      ) {
        this.ANP = this.ANP.add(this.ZRE4)
          .subtract(this.ZVBEZ)
          .setScale(0, BigDecimal.ROUND_UP)
      } else {
        this.ANP = this.ANP.add(Lohnsteuer2020.ZAHL1000)
      }
    }
  }
  this.KZTAB = 1
  if (this.STKL == 1) {
    ...
    this.KFB = this.ZKF.multiply(BigDecimal.valueOf(7812)).setScale(
      0,
      BigDecimal.ROUND_DOWN,
    )
  } else {
    if (this.STKL == 2) {
      ...
      if (this.STKL == 3) {
        ...
        if (this.STKL == 4) {
          this.SAP = BigDecimal.valueOf(36)
          this.KFB = this.ZKF.multiply(BigDecimal.valueOf(3906)).setScale(
            0,
            BigDecimal.ROUND_DOWN,
          )
        } else {
...
Lohnsteuer2020.prototype.MLSTJAHR = function () {
  ...
  if (this.KENNVMT != 1) {
    ...
    this.ZVE = this.ZRE4.subtract(this.ZTABFB)
      .subtract(this.VSP)
      .subtract(this.VMT.divide(Lohnsteuer2020.ZAHL100))
      .subtract(this.VKAPA.divide(Lohnsteuer2020.ZAHL100))
      .setScale(2, BigDecimal.ROUND_DOWN)
    if (this.ZVE.compareTo(BigDecimal.ZERO()) == -1) {
      this.ZVE = this.ZVE.add(this.VMT.divide(Lohnsteuer2020.ZAHL100))
        .add(this.VKAPA.divide(Lohnsteuer2020.ZAHL100))
        .divide(Lohnsteuer2020.ZAHL5)
        .setScale(2, BigDecimal.ROUND_DOWN)
      this.UPMLST()
      this.ST = this.ST.multiply(Lohnsteuer2020.ZAHL5).setScale(
        0,
        BigDecimal.ROUND_DOWN,
      )
    } else {
      ...
      this.ZVE = this.ZVE.add(
        this.VMT.add(this.VKAPA).divide(Lohnsteuer2020.ZAHL500),
      ).setScale(2, BigDecimal.ROUND_DOWN)
      this.UPMLST()
      this.ST = this.ST.subtract(this.STOVMT)
        .multiply(Lohnsteuer2020.ZAHL5)
        .add(this.STOVMT)
        .setScale(0, BigDecimal.ROUND_DOWN)
    }
  }
...
Lohnsteuer2020.prototype.UPVKV = function () {
  if (this.PKV > 0) {
    if (this.VSP2.compareTo(this.VSP3) == 1) {
      this.VKV = this.VSP2.multiply(Lohnsteuer2020.ZAHL100)
    } else {
      this.VKV = this.VSP3.multiply(Lohnsteuer2020.ZAHL100)
    }
  } else {
...
Lohnsteuer2020.prototype.MVSP = function () {
  ...
  if (this.PKV > 0) {
    if (this.STKL == 6) {
      ...
      this.VSP3 = this.PKPV.multiply(Lohnsteuer2020.ZAHL12).divide(
        Lohnsteuer2020.ZAHL100,
      )
      if (this.PKV == 2) {
...
Lohnsteuer2020.prototype.MSOLZ = function () {
  ...
  if (this.JBMG.compareTo(this.SOLZFREI) == 1) {
    ...
    this.JW = this.SOLZJ.multiply(Lohnsteuer2020.ZAHL100).setScale(
      0,
      BigDecimal.ROUND_DOWN,
    )
    this.UPANTEIL()
  ...
  if (this.LZZ == 1) {
    ...
    if (this.LZZ == 2) {
      this.ANTEIL1 = this.JW.divide(
        Lohnsteuer2020.ZAHL12,
        0,
        BigDecimal.ROUND_DOWN,
      )
    } else {
      if (this.LZZ == 3) {
        this.ANTEIL1 = this.JW.multiply(Lohnsteuer2020.ZAHL7).divide(
          Lohnsteuer2020.ZAHL360,
          0,
          BigDecimal.ROUND_DOWN,
        )
      } else {
...
Lohnsteuer2020.prototype.MSONST = function () {
  ...
  if (this.SONSTB.compareTo(BigDecimal.ZERO()) == 0) {
    ...
    this.STS = this.LSTSO.subtract(this.LSTOSO)
      ...
      .divide(Lohnsteuer2020.ZAHL100, 0, BigDecimal.ROUND_DOWN)
      .multiply(Lohnsteuer2020.ZAHL100)
...
Lohnsteuer2020.prototype.MVMT = function () {
  ...
  if (this.VMT.add(this.VKAPA).compareTo(BigDecimal.ZERO()) == 1) {
    ...
    this.MRE4ABZ()
    this.ZRE4VP = this.ZRE4VP.subtract(
      this.JRE4ENT.divide(Lohnsteuer2020.ZAHL100),
    ).subtract(this.SONSTENT.divide(Lohnsteuer2020.ZAHL100))
    this.KENNVMT = 1
    this.MLSTJAHR()
    ...
    this.SOLZV = this.STV.multiply(BigDecimal.valueOf(5.5))
      .divide(Lohnsteuer2020.ZAHL100)
      .setScale(0, BigDecimal.ROUND_DOWN)
    if (this.R > 0) {
      this.BKV = this.STV
...
Lohnsteuer2020.prototype.MOSONST = function () {
  this.ZRE4J = this.JRE4.divide(Lohnsteuer2020.ZAHL100).setScale(
    2,
    BigDecimal.ROUND_DOWN,
  )
  this.ZVBEZJ = this.JVBEZ.divide(Lohnsteuer2020.ZAHL100).setScale(
    2,
    BigDecimal.ROUND_DOWN,
  )
...
Lohnsteuer2020.prototype.UPTAB20 = function () {
  if (this.X.compareTo(this.GFB.add(Lohnsteuer2020.ZAHL1)) == -1) {
    this.ST = BigDecimal.ZERO()
  } else {
    if (this.X.compareTo(BigDecimal.valueOf(14533)) == -1) {
      this.Y = this.X.subtract(this.GFB).divide(
        Lohnsteuer2020.ZAHL10000,
        6,
        BigDecimal.ROUND_DOWN,
      )
      ...
      if (this.X.compareTo(BigDecimal.valueOf(57052)) == -1) {
        this.Y = this.X.subtract(BigDecimal.valueOf(14532)).divide(
          Lohnsteuer2020.ZAHL10000,
          6,
          BigDecimal.ROUND_DOWN,
        )
        ...
        this.ST = this.RW.add(BigDecimal.valueOf(972.79)).setScale(
          0,
          BigDecimal.ROUND_DOWN,
        )
      } else {
        if (this.X.compareTo(BigDecimal.valueOf(270501)) == -1) {
          this.ST = this.X.multiply(BigDecimal.valueOf(0.42))
            .subtract(BigDecimal.valueOf(8963.74))
            .setScale(0, BigDecimal.ROUND_DOWN)
        } else {
          this.ST = this.X.multiply(BigDecimal.valueOf(0.45))
            .subtract(BigDecimal.valueOf(17078.74))
            .setScale(0, BigDecimal.ROUND_DOWN)
        }
      }
    }
